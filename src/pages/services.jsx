    ...
    <div>
      ...
      <div className='lg:w-[85%] w-full my-12 mx-auto flex flex-wrap items-center text-center lg:text-left'>
        <div className='lg:w-1/2 px-5 w-full'>
         <h1 className="text-3xl font-semibold family-garamond">More than Luxury</h1>
        </div>
      ...
      <div className='lg:w-[85%] w-full  mx-auto flex flex-wrap items-center'>
        ...
        <div className='lg:w-1/2 p-5 w-full flex flex-col gap-10 items-start text-lg text-gray-600'>
          ...
          <button className='px-6 py-2 bg-[#149088] text-white'>BOOK CONSULTATION</button>
        </div>
      ...
      <div className='lg:w-[85%] w-full mx-auto flex flex-wrap-reverse items-center'>
        ...
        <div className='lg:w-1/2 w-full flex flex-col p-5 gap-10 items-start text-lg text-gray-600'>
          <h1 className='lg:text-4xl text-3xl font-semibold family-garamond text-black'>Luxury Cars & Chauffeurs
          </h1>
      ...
      <div className='lg:w-[85%] w-full mb-10 mx-auto flex flex-wrap items-center'>
        <div className='lg:w-1/2 w-full'>
          <img src="./service-3.jpg" alt="" loading="lazy" className="w-full  object-cover object-center" />
        </div>
        <div className='lg:w-1/2 p-5 w-full flex flex-col gap-10 items-start text-lg text-gray-600'>
          <h1 className='lg:text-4xl family-garamond text-3xl font-semibold text-black'>Private Jet & Air Transport
          </h1>
