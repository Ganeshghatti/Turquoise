...
const services = () => {
  return (
    <div>
      ...
      <section className="xl:w-[80%] lg:w-[85%] w-full mx-auto my-12 service-section">
      <div className='flex flex-wrap items-center mb-12 text-center lg:text-left'>
        <div className='lg:w-1/2 p-5 w-full'>
        ...
        <div className='flex flex-wrap items-center'>
          ...
          <div className='lg:w-1/2 lg:p-10 p-5 w-full flex flex-col gap-10 items-start text-lg text-gray-600'>
            ...
            <button className='px-12 py-4  text-white'>BOOK CONSULTATION</button>
          </div>

        </div>
        <div className='flex flex-wrap-reverse items-center'>

          <div className='lg:w-1/2 w-full flex flex-col lg:p-10 p-5 gap-10 items-start text-lg text-gray-600'>
        ...
        <div className='flex flex-wrap items-center'>
          <div className='lg:w-1/2 w-full'>
            <img src="./service-3.jpg" alt="" loading="lazy" className="w-full  object-cover object-center" />
          </div>
          <div className='lg:w-1/2 lg:p-10 p-5 w-full flex flex-col gap-10 items-start text-lg text-gray-600'>
