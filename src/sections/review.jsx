      ...
      <div className="embla overflow-hidden" ref={emblaRef}>
        <div className="embla__container flex  ">
          {reviews.map((review, index) => (
            <div 
              key={index} 
              className="embla__slide flex-grow-0 flex-shrink-0 w-[calc(100%/3)] min-w-[300px] max-w-[calc(100%/3-12px)] ml-4"
            >
               <div
                className="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white    ">
